...
[`src/crush/interfaces/api/local_music.py`](../../src/crush/interfaces/api/local_music.py)
...
[`src/crush/interfaces/api/config/devices.py`](../../src/crush/interfaces/api/config/devices.py)
...
[`src/crush/providers/audio/stt.py`](../../src/crush/providers/audio/stt.py) force :

```python
WhisperModel(settings.whisper_model, device="auto", compute_type="float16")
```

À noter : le chemin **temps réel** ([`receiver.py`](../../src/crush/providers/audio/receiver.py),
...
> fichiers, à garder sur un poste équipé d'un GPU (hors Crush).
