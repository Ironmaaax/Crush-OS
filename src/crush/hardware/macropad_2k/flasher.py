...
from crush.hardware.macropad_2k.arduino_cli import (
    BOARD_INDEX,
    FQBN,
    ensure_arduino_cli,
    ensure_ch55x_core,
...
from crush.hardware.macropad_2k.firmware_gen import generate
from crush.hardware.macropad_2k.ihex import ihex_to_bin_file
from crush.hardware.macropad_2k.models import KeypadProfile
