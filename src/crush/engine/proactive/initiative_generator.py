...
from crush.engine.proactive.context_builder import WorldState
...
def _draft_system(name: str) -> str:
    return (
        f"\nTu es Crush, assistant de {name}. Rédige un brouillon d'email professionnel,\n"
...
def _rectify_system(name: str) -> str:
    return (
        f"\nTu es Crush, assistant proactif de {name}. Tu dois régénérer une initiative\n"
