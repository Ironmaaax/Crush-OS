...
Crush ne "fait pas des trucs" : il gère des WORKSTREAMS. Le Command Center
...
from crush.kernel.schemas import SkillStatus
...
class CommandCenterSnapshot:
    """Snapshot complet de l'état Crush pour le Command Center."""
...
class CommandCenter:
    """Agrégateur lecture-seule des workstreams Crush."""
