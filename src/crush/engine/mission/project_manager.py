...
from crush.engine.mission.schemas import Project, Step, StepStatus
...
class ProjectManager:
    ...
    async def create_project(self, mission: str, timeout_minutes: int = 30) -> Project:
        ...
        raw = await self._llm.complete(
            ...
            stream=False,
            # « mission » sans identifiant : le projet n'existe pas encore, on
            # est en train de le planifier. Le préfixe `mission:` inventerait
            # un projet dans le budget.
            context="mission",
        )
