...
from crush.engine.audit import AuditLog
from crush.engine.budget import BudgetGuard
from crush.engine.mission.docker_executor import DockerExecutor
from crush.engine.mission.file_tool import SandboxedFileTool
from crush.engine.mission.governance import GateContext, GateDecision, Governance
from crush.engine.mission.project_store import ProjectStore
from crush.engine.mission.quality_checker import QualityChecker
from crush.engine.mission.reflexion import Reflexion
from crush.engine.mission.schemas import LogEntry, Project, ProjectStatus, Step, StepStatus
from crush.engine.mission.verifier import Verifier
from crush.engine.mission.worker_cli import WorkerCLITool
from crush.engine.vocab import AccessLevel
from crush.kernel.approvals import approval_config
from crush.kernel.contracts import LLMProvider
from crush.kernel.events import EventBus, MissionCompleted
...
class WorkerAgent:
    ...
    def _ensure_governance(self) -> None:
        ...
        audit_path = Path(self._project.workspace_path) / ".crush" / "audit.jsonl"
        self._governance = Governance(
    ...
    async def _tool_executor(self, name: str, inputs: dict) -> str:
        ...
        try:
            ...
            if name == "fusion_360":
                from crush.capabilities.tools.fusion import FusionTool  # lazy: plugin Fusion
