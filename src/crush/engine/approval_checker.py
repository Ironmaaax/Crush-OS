...
# Phase F : le singleton vit en `crush.kernel.approval` pour permettre aux
...
from crush.kernel.approval import get_approval_checker, set_approval_checker  # noqa: F401
