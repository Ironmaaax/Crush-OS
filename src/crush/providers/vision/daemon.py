...
from crush.providers.vision.face_recognizer import FaceRecognizer
from crush.providers.vision.object_detector import ObjectDetector
from crush.providers.vision.objects_queue import get_vision_objects_queue
...
_CRUSH_WEBHOOK = "http://localhost:8000/api/webhooks"
_TARGET_FPS = 2
...
async def _send_event(client: httpx.AsyncClient, event_type: str, data: dict) -> None:
    try:
        await client.post(f"{_CRUSH_WEBHOOK}/{event_type}", json=data)
