...
_CATEGORY_TO_FILE: dict[str, str] = {
    ...
    "persona": "crush/persona.md",
    "memory_correction": "crush/corrections.md",
}

_UNCERTAIN_FILE = "crush/uncertain-beliefs.md"
_NEEDS_REVIEW_FILE = "crush/needs-review.md"
...
_HEADER_WARNING = (
    ...
    "<!-- Pour corriger : utiliser la commande Crush (crée un human_correction). -->\n"
)
