...
from crush.kernel.contracts import CapabilityEngine


class ReportMissingCapabilityTool(Tool):
    """Signale un type de tâche que Crush ne sait pas faire.
    ...
    description = (
        "Signaler à Crush un type de tâche qu'il ne sait pas faire (ex. "
