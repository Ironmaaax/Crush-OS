...
from crush.kernel.paths import SKILLS_CANDIDATES_DIR, SKILLS_INSTALLED_DIR  # noqa: F401, E402
...
_PROMPT_PROPOSE = """\
Analyse cette tâche Crush accomplie avec succès et génère un skill réutilisable.
...
_PROMPT_IMPROVE = """\
Améliore ce skill Crush avec une nouvelle expérience.
...
class SkillSynthesizer:
    """Génère et améliore des skills Crush depuis des tâches accomplies.
    ...
    # ── Génération fichiers Crush ────────────────────────────────────────────

    @staticmethod
    def _to_crush_yaml(fm: dict, body: str) -> dict:
        """Convertit le frontmatter agentskills.io + corps en skill.yaml Crush."""
        ...
        return {
            ...
            "version": version,
            "author": str(metadata.get("author", "crush-synthesizer")),
    ...
    def _generate_skill_py(skill_name: str) -> str:
        """Génère le skill.py Crush minimaliste pour le skill synthétisé."""
        ...
        return textwrap.dedent(f'''\
            ...
            class {class_name}(SkillBase):
                """Skill synthétisé automatiquement par Crush."""
