...
"""Classe de base pour tous les skills Crush."""
...
from crush.capabilities.tools.base import Tool
...
class SkillBase(ABC):  # noqa: B024 — sous-classes surchargent par convention, pas via abstractmethod
    """
    Un skill est une extension de capacité pour Crush.

    SYSTEM_PROMPT est injecté automatiquement dans le contexte
    de Crush à chaque conversation quand le skill est installé.
