...
les contributeurs développant dans `crush-skills` :

    ~/.crush/extensions/dev/
        skills/<name>   -> symlink vers ../crush-skills/skills/<name>
        presets/<name>  -> symlink vers ../crush-skills/skills/<name>
        views/<name>    -> symlink vers ../crush-skills/views/<name>

Inerte par défaut : si la zone n'existe pas ou est vide, toutes les
fonctions sont no-op et le comportement de Crush est strictement
...
def dev_root() -> Path:
    """Racine de la zone dev. Override possible via CRUSH_DEV_EXTENSIONS_DIR (pour les tests)."""
