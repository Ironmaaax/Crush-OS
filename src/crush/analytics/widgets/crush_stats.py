...
"""Widget Crush Stats — données internes, aucune API externe."""

import json
from datetime import date, timedelta

from crush.analytics.widgets.base import WidgetBase, WidgetData
from crush.kernel.paths import MEMORY_DATA_DIR


class CrushStatsWidget(WidgetBase):
    id = "crush_stats"
    label = "Crush Stats"
    description = "Conversations, missions, tokens et coûts Crush."
    icon = "J"
    requires_env = []
    size = "medium"
