...
from crush.interfaces.channels.base import (  # noqa: E402
    ChannelAdapter,
    DispatchCallback,
    IncomingMessage,
    MessageTarget,
...
class TelegramChannel(ChannelAdapter):
    ...
    async def send_message(self, text: str) -> None:
        """Envoie un message proactif à l'owner (notifications Crush)."""
    ...
    async def _cmd_help(
        ...
        text = (
            ...
            "📄 Code source (AGPL-3.0) : https://github.com/Ironmaaax/Crush-OS"
        )
        await update.message.reply_text(
