...
"""Stub WhatsApp pour Crush — à implémenter via Twilio ou WhatsApp Business API."""

from __future__ import annotations

from crush.interfaces.channels.base import ChannelAdapter, MessageTarget, Platform
