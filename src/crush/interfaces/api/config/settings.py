...
from crush.interfaces.api.config._env import (
    _LLM_HOT_SWAP_KEYS,
    _RESTART_KEYS,
    _SENSITIVE_KEYS,
    _SETTINGS_FIELD_MAP,
...
from crush.kernel.approvals import approval_config as _approval_cfg
from crush.kernel.settings import settings as _s
from crush.providers.llm.factory import create_background_llm, get_llm_provider
...
async def get_voices() -> list[dict]:
    ...
    try:
        ...
        if r.status_code == 200:
            from crush.providers.audio.elevenlabs_voices import voice_api_available
