...
from crush.interfaces.api.config.devices import router as _devices_router
from crush.interfaces.api.config.llm import router as _llm_router
from crush.interfaces.api.config.permissions import router as _permissions_router
from crush.interfaces.api.config.settings import router as _settings_router
