...
from crush.hardware.macropad_2k.arduino_cli import find_arduino_cli, install_arduino_cli
from crush.hardware.macropad_2k.flasher import compile_firmware, upload_firmware
from crush.hardware.macropad_2k.launcher import (
    create_app_launcher,
    is_windows,
    list_installed_apps,
    open_device_manager,
)
from crush.hardware.macropad_2k.models import (
    KeypadUsbStatus,
    WorkspaceProfileBundle,
    get_active_profile,
)
from crush.hardware.macropad_2k.paths import (
    arduino_cli_executable,
    firmware_root,
    is_valid_workspace,
)
from crush.hardware.macropad_2k.profile_store import (
    load_bundle,
...
from crush.interfaces.api.ui import inject_client_config
...
async def keypad_ui() -> Response:
    content = Path("src/crush/interfaces/ui/static/macropad_2k.html").read_text(encoding="utf-8")
    return Response(
