...
from crush.capabilities.skills.installer import skill_installer
from crush.capabilities.skills.lifecycle import SkillStatus
...
async def install_skill(skill_name: str, request: Request) -> dict:
    """Installe un skill depuis le repo crush-skills."""
...
async def reload_skills(request: Request) -> dict:
    """Recharge les skills et leurs outils sans redémarrer Crush."""
