/* macropad_2k.js — Macropad 2 touches Le Labo, integrated inside Crush V4.
 * Vanilla JS port of the original React/Tauri studio.
 * Uses Crush design system (mountSidebar, mountTopbar) + macropad_2k.css.
 */
(function () {
  "use strict";
  ...
  function renderAboutPage() {
    ...
    info.appendChild(btn({ onClick: () => window.open("https://github.com/Ironmaaax/Crush-OS", "_blank") }, "Ouvrir GitHub"));
    ...
    if (isEmbedded) {
      ...
      J.mountSidebar({
        sections: [
          ...
          {
            label: window.CRUSH_ASSISTANT_NAME || "Crush",
            items: [
