/**
 * Vue System Monitor — crush-skills
 * Dashboard cockpit temps réel : CPU, RAM, disque, cerveau LLM, services Crush,
 ...
 *
 * Données RÉELLES (inchangées) via l'API Crush :
    ...
    content.innerHTML = `
      ...
      <div class="sm-top">
        ...
        <div class="sm-card sm-brain" id="sm-panel-llm">
          <span class="sm-eyebrow">Cerveau Crush · provider actif</span>
      ...
      <div class="sm-mid">
        <div class="sm-card sm-panel" id="sm-panel-services">
          <span class="sm-eyebrow">Services · écosystème Crush</span>
          <div class="sm-rows">
      ...
      <div class="sm-bot">
        ...
        <div class="sm-card sm-cell">
          <span class="sm-cell-l">Processus Crush</span>
