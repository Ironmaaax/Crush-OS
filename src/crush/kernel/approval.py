...
de pending) reste dans `crush.engine.approval_checker`. Ce module-ci
expose UNIQUEMENT l'accessor singleton, parce que :
  ...
  - capabilities/ n'a le droit d'importer QUE crush.kernel (RÈGLE 2) ;
...
if TYPE_CHECKING:
    from crush.kernel.contracts import ApprovalChecker
