...
"""kernel — L0 de l'architecture crush-OS.
...
Sous-modules :
- errors    — hiérarchie d'exceptions Crush
...
API publique (`__all__`) — pour `from crush.kernel import X` :
...
from crush.kernel.events import EventBus, bus
from crush.kernel.settings import Settings, settings
