...
async def test_run_direct_refused_without_opt_in(
    ...
    # `from crush.kernel.settings import settings` (backend_factory.py,
    ...
    # dans `crush/kernel/__init__.py:49` qui shadow le sous-module.
    from crush.kernel.settings import settings as _settings_singleton
