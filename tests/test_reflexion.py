...
# ── 8. Format text de la leçon contient 'crush decided' pour faciliter ──────
#     l'extraction d'un fact decision par l'extracteur PHASE 3.


async def test_format_text_inclut_crush_decided(kernel: MemoryKernel) -> None:
