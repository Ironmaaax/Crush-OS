...
from crush.engine.mission.reflexion import Reflexion  # noqa: E402
from crush.engine.mission.schemas import Project, Step, validate_step  # noqa: E402
from crush.engine.mission.worker_agent import WorkerAgent  # noqa: E402
from crush.engine.vocab import AccessLevel  # noqa: E402
from crush.kernel.settings import settings
from crush.providers.llm.api import AnthropicProvider
from crush.providers.memory.ingest import MemoryIngest  # noqa: E402
from crush.providers.memory.kernel import MemoryKernel  # noqa: E402
from crush.providers.memory.schemas import FactStatus  # noqa: E402
...
async def main() -> int:
    ...
    db_path = workspace / "crush_memory.db"
    if db_path.exists():
        db_path.unlink()
