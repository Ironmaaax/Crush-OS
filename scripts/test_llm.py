...
from crush.providers.llm.api import AnthropicProvider, MistralProvider, OpenAIProvider
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test LLM Provider — Crush Phase 1")
    parser.add_argument(
        "--provider",
